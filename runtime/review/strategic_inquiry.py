...
_PRODUCT_SUPPLY_QUESTIONS: list[StrategicQuestion] = [
    ...
    StrategicQuestion(
        ...
        "하자담보책임(민법상)과 제조물 책임(제조물책임법상)을 분리하여 각각의 기간·범위를 별도로 규정하였는가? (정확한 조문은 법무 확인 필요)",
    ...
    },
    {
        ...
        "questions": [
            ...
            StrategicQuestion("OV-MHD-003", 0, "위험성 평가",
                "착공 전 위험성 평가(산업안전보건법상 의무)를 실시하고 결과를 상대방에게 제출하는 절차가 있는가? (정확한 조문은 법무 확인 필요)",
    ...
    },
    {
        ...
        "questions": [
            ...
            StrategicQuestion("OV-PI-002", 0, "수탁자 관리감독",
                "개인정보 수탁자에 대한 관리·감독 의무(개인정보보호법상 의무)가 명시되어 있는가? (정확한 조문은 법무 확인 필요)",
                False, ["pi_legal_compliance"]),
    ...
    },
    {
        ...
        "questions": [
            ...
            StrategicQuestion("OV-SUB-002", 0, "기술 유용 금지",
                "원사업자의 기술 유용(하도급법상 금지) 방지 조항이 포함되어 있는가? (정확한 조문은 법무 확인 필요)",
                False, ["SC-IP-001"]),
