...
#  구체적 조문 번호(제N조)는 여기서 출력하지 않는다 — 국가법령정보 API/검증된
#  DB로 확인되지 않은 조문 번호를 AI/룰 엔진이 추정해 표시하면 안 되기 때문
#  (requirement.md 2026-08-28 지시: 법령/조문 번호는 실제 확인된 경우에만 출력).
#  법률 명칭 및 쟁점 요약까지만 제공하고, 정확한 조문은 법무 담당자가 직접 확인한다.
_TOPIC_LEGAL_BASIS: dict[str, str] = {
    "termination": "대리점법 및 판례상 해지권 남용 제한 법리 (정확한 조문은 법무 확인 필요)",
    "cost_burden": "대리점법 및 공정거래법상 거래상 지위 남용 금지 법리 (정확한 조문은 법무 확인 필요)",
    "payment_settlement": "하도급법 및 민법상 상계 요건 관련 법리 (정확한 조문은 법무 확인 필요)",
    "personal_data": "개인정보 보호법상 수탁자 관리·감독 의무 법리 (정확한 조문은 법무 확인 필요)",
    "ip_ownership": "저작권법상 업무상 저작물 귀속 원칙 및 도급 계약 적용 법리 (정확한 조문은 법무 확인 필요)",
    "safety": "산업안전보건법 및 중대재해처벌법상 도급인·수급인 안전 관리 의무 (정확한 조문은 법무 확인 필요)",
    "safety_compliance": "산업안전보건법 및 중대재해처벌법상 안전 관리 의무 (정확한 조문은 법무 확인 필요)",
    "damage": "민법상 손해배상 범위 및 제조물책임법상 입증책임 전환 법리 (정확한 조문은 법무 확인 필요)",
    "dealer_unfair": "공정거래법 및 대리점법상 불이익 제공 금지 법리 (정확한 조문은 법무 확인 필요)",
    "confidentiality": "부정경쟁방지법상 영업비밀 보호 및 민법상 불법행위 법리 (정확한 조문은 법무 확인 필요)",
    "training_operations": "산업안전보건법상 안전보건교육 실시 의무 (정확한 조문은 법무 확인 필요)",
}
